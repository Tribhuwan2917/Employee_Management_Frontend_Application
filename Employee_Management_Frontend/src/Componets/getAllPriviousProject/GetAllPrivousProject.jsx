              ...
              <tbody>
                {employeePriviousProject.map((priviousProject, index) => (
                  <tr key={index} style={{textAlign:'center'}}>
                    ...
                    <td>{priviousProject.priviousProjectLink ? <div style={{backgroundColor: '#0066FF', height: '38px', paddingTop: '5px', borderRadius: '6px', color: 'white', fontWeight: 450 }}>{<Link style={{ fontSize: '18px', color: 'inherit',width: '100px', textDecoration: 'none', color: 'white', paddingTop: '30px' }} to={priviousProject.priviousProjectLink}>Click here</Link>}</div> : 'In Dev Phase'}</td>
