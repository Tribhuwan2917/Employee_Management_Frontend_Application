                    ...
                    <Table striped bordered hover>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{currentProject.currentProjectLink?<div style={{ backgroundColor: '#0066FF', height: '38px', paddingTop: '5px', width: '100px', borderRadius: '6px', color: 'white', fontWeight: 450 }}>{<Link style={{ fontSize: '18px', color: 'inherit', textDecoration: 'none', color: 'white', paddingTop: '30px' }} to={currentProject.currentProjectLink}>Click here</Link>}</div>:'In Dev Phase'}</td>
