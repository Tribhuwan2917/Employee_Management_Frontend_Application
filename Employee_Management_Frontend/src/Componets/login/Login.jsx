                ...
                <Card.Text>
                  <form onSubmit={handleSubmit}>
                    <div style={{ padding: '2px' }}>
                      ...
                      {errors.registrationEmail && touched.registrationEmail ? <Alert style={{ marginTop:'2px', marginLeft:'135px',width:'300px',height:'35px',paddingBottom:'35px'}} variant='danger'>
                    ...
                    <div style={{ padding: '2px' }}>
                      ...
                      <br></br>
                      {errors.registraionPassword && touched.registraionPassword ? <Alert style={{ marginTop:'2px', marginLeft:'135px',width:'300px',height:'35px',paddingBottom:'35px'}} variant='danger'>
                        {errors.registraionPassword}
                      </Alert> : null}
                    </div>
                    <div style={{marginLeft:'-190px', marginTop:'5px'}}><Link style={{textDecoration:'none'}} to="/forgotPassword">Forgot Password</Link></div>
