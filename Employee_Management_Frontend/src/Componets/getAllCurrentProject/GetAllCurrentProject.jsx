                        ...
                        <tbody>
                            {allCuurentProjectData.map((currentProject, index) => (
                                <tr key={index}>
                                    ...
                                    <td>{currentProject.currentProjectLink ? <div style={{ marginLeft:'30px', backgroundColor: '#3377FF', height: '38px', paddingTop: '5px', width: '100px', borderRadius: '6px', color: 'white', fontWeight: 450 }}>{<Link style={{ fontSize: '18px', color: 'inherit', textDecoration: 'none', marginLeft: '10px', color: 'white', paddingTop: '30px' }} to={currentProject.currentProjectLink}>Click here</Link>}</div> : "In Dev Phase"}</td>
                                    <td>{<Button style={{ marginLeft:'30px', width: '100px', backgroundColor: 'red' }} onClick={(event) => handleDelete(currentProject.currentProjectId)}>Delete</Button>}</td>
